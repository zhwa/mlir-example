...
**Next steps**: Chapter 12 composes attention with feed-forward networks and layer normalization to build full transformer blocks. Chapter 13 stacks these blocks into complete GPT architecture. Chapter 14 applies production optimizations (Transform dialect techniques, KV caching, advanced lowering patterns). Chapter 15 explores GPU concepts. Attention is the heart of transformers—mastering its implementation provides the foundation for modern AI compilers.